...
class TestPaginator:
    ...
    def test_paginator_basic(self):
        ...
        assert paginator.total_pages == 4  # BUG! Should be 3
    ...
    def test_paginator_exact_division(self):
        ...
        assert paginator.total_pages == 3  # BUG! Should be 2
        ...
        # BUG 3: This page shouldn't exist
        page3 = paginator.page(3)
        assert len(page3) == 0  # Empty page!
    ...
    def test_paginator_single_page(self):
        ...
        assert paginator.total_pages == 2  # BUG! Should be 1
    ...
    def test_has_next(self):
        ...
        assert paginator.has_next(3)
        assert not paginator.has_next(4)
